...
export const updateCardAC = (card: CardResponceType) => {
    ...
    export const getCardsTC =
        (): AppThunk => (dispatch: Dispatch<CardActionsType>) => {
    cardAPI.getCards()
        .then((res) => {
...
export const addCardTC =
    (card: CardResponceType): AppThunk => (dispatch: Dispatch<CardActionsType>) => {
    ...
    export const updateCardTC =
        (updateCard: UpdateCardType): AppThunk => (dispatch: Dispatch<CardActionsType>) => {
