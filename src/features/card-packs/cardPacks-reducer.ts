...
export const getPacksTC = (): AppThunk => (dispatch: Dispatch<CardPacksActionsType>) => {
...
export const addPackTC =
  ...
  (dispatch: Dispatch<CardPacksActionsType>) => {
    cardPacksAPI.addPack(cardsPack).then(res => {
      console.log(res)
    })
  }

export const deletePackTC = (): AppThunk => (dispatch: Dispatch<CardPacksActionsType>) => {
